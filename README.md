...
[![Version](https://img.shields.io/badge/version-0.3.0.3-blue)](version.xml)
[![License](https://img.shields.io/badge/license-GPL--3.0-lightgrey)](LICENSE)

**⬇️ Install package:** [OMP 3.5](https://github.com/OJSBR/pdfFlipbookOmp/releases/download/0.3.0.3-omp3.5/pdfFlipbook-0.3.0.3-omp3.5.tar.gz) — or browse all [Releases](../../releases).
...
|-------------|---------|--------|----------------|
| OMP | 3.5.x | [`stable-3_5_0`](../../tree/stable-3_5_0) *(default)* | 0.3.0.3 |
...
|-----------|--------|--------|-------------------|
| OMP | 3.5.x | [`stable-3_5_0`](../../tree/stable-3_5_0) *(padrão)* | 0.3.0.3 |
